...
const services = [
  ...
  },
  {
    ...
    distance: "2km",
    rating: 4.0,
    image: "https://www.vinavu.com/wp-content/uploads/2017/10/narendra-modi-funny-pictures.jpg",
    address: "Namak mandi",
  },
  {
    id: 5,
...
const ServicesPage = () => {
  ...
  const handleSearch = async () => {
    try {
      const response = await fetch(`/api/services?query=${searchQuery}&radius=${radius}`);
